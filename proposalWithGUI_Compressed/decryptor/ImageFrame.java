...
public class ImageFrame {
	private String[] toDisplayText = {"Decrypt SuccessFully", "Error", "All Data Deleted Sucessfully"};
	...
	private JButton decryptImageButton, goBackButton, proceedButton, deleteButton;
		...
		public void actionPerformed(ActionEvent event) {
			if(event.getSource() == decryptImageButton) {
				...
				if(response == JFileChooser.APPROVE_OPTION) {
					...
					try {
						new DecryptImage(file, imageNameField.getText());
				...
				DecryptImage encryptImageObject = new DecryptImage();
	...
	public void buttons() {
		...
		deleteButton = new JButton("Delete All Decrypted Image");
	...
	//The Image Decryption JPanels
	public void panels() {
		
		panelInPanelS1 = new JPanel();
		panelInPanelS1.setLayout(new GridLayout());
		panelInPanelS1.add(decryptImageButton);
